...
function ResquestRequestGetInfosAllUserSuccess(response) {
    ...
    for(let i = 0 ; i < response.length ; i++){
        ...
        let tdUseDroit = $("<td>").html(response[i].use_droit + " <button type=button class=\"btn  btn-primary btn-visualisationUserFood\" id=visualisationUserFood_"+ response[i].use_id +" onclick=VisualisationFoodUser(" + response[i].use_id + ")>-></td>")
        ...
        //$("#cardBodyPanneauAdminID").append(labelUseId, labelUseName, labelUseMail, labelUseDroit)
    }
